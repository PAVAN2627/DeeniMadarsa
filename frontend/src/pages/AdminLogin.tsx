        ...
        <div className="bg-[#fdf8f0] flex flex-col justify-center px-8 py-8 md:w-3/5">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-9 pr-9 h-9 text-sm bg-white border-gray-200"
                  value={password}
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-10 text-sm font-bold tracking-widest uppercase bg-[#0d3320] hover:bg-[#1a5c38] text-white mt-2"
            >
