    ...
    <Layout>
      ...
      <section className="relative h-auto sm:h-[80vh] min-h-0 flex items-start sm:items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="/WhatsApp Image 2026-04-13 at 10.32.41 AM.jpeg" alt="Courses" className="w-full h-full object-cover scale-110 transition-transform duration-[8s] ease-out" />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -top-10 -left-10 w-72 h-72 rounded-full border border-white/5" />
          <div className="absolute top-1/3 right-1/4 w-64 h-64 rounded-full bg-yellow-400/10 blur-3xl" />
          <div className="absolute bottom-1/4 left-1/3 w-48 h-48 rounded-full bg-teal-400/10 blur-3xl" />
