      ...
      <section className="py-20 bg-white -mt-px">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-12">
            ...
            <h2 className="font-heading text-3xl font-bold text-foreground">{t("donation.subtitle")}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl border border-teal-100/60 hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="p-8 text-center">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-700 flex items-center justify-center mx-auto mb-5 shadow-md">
                  <Smartphone className="w-7 h-7 text-white" />
                </div>
                <h3 className="font-heading text-xl font-bold text-foreground mb-3">{t("donation.upi")}</h3>
                <p className="font-mono text-lg text-teal-700 bg-teal-50 px-4 py-2 rounded-xl border border-teal-100 inline-block">
                  madarsa@upi
                </p>
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl border border-teal-100/60 hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="p-8">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-yellow-500 to-yellow-700 flex items-center justify-center mx-auto mb-5 shadow-md">
                  <CreditCard className="w-7 h-7 text-white" />
                </div>
                <h3 className="font-heading text-xl font-bold text-foreground mb-4 text-center">{t("donation.bank")}</h3>
                <div className="space-y-3">
                  {[t("donation.bank.name"), t("donation.bank.account"), t("donation.bank.ifsc")].map((item, i) => (
                    <div key={i} className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-2.5 text-sm text-foreground">
